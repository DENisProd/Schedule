    ...
    return (
        <header className="view-container">
            ...
            {props.isLoaded && props.isGroup &&
                <svg onClick={() => props.addToCompare(props.group.group.groupID, props.group.group.name)}
                     className="compare-btn" width="800px" height="800px" viewBox="0 0 24 24"
                     xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
                          d="M3 12a1 1 0 0 1 1-1h12a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1ZM3 8a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1ZM3 16a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1Z"/>
                </svg>
            }
...
const ViewHeader = (props) => {
    ...
    return (
        <div className={cn("view-header", settings?.calDir === "top" && "top")}>
            ...
            <CalendarComponent currentDate={props.currentDate} updateSchedule={props.updateSchedule}
                               groupedRasp={props.groupedRasp}
